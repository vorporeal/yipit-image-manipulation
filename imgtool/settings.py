...
ADMINS = (
    ('David Stern', 'vorporeal@gmail.com'),
    ('Stephen Hebson', 'shebson@gmail.com'),
    ('Ben Leib', 'bgleib@gmail.com'),
    ('Roger Fong', 'roger.d.fong@gmail.com')
)
...
AWS_STORAGE_BUCKET_NAME = 'yipit-lowercase'
